...
struct Item:View{
            ...
            ZStack {
                VStack{
                    ...
                    HStack {
                        ...
                        //add button
                        NavigationLink(destination:Add(itemsInCart:$itemsInCart,keys:allFood.filter{$0.name == self.name}[0].menuItemsKeys,values:allFood.filter{$0.name == self.name}[0].menuItemsValues,quantity:quantity,name:self.name).navigationBarHidden(true)){
                            ZStack {
    ...
    init(itemsInCart:Binding<[FoodItem:Int]>,itemType:Category = .burger,name:String="BigMac",image:String="bigmac" ,price:Float=6.99,text:String="""
