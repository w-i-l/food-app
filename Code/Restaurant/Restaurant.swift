                        ...
                        ForEach(Array(stride(from: 0, to: items.count, by: 2)),id:\.self){no in
                                    ...
                                    HStack(spacing:10){
                                        ...
                                        if no+1<items.count{
                                            ...
                                            NavigationLink(destination:Item(itemsInCart:$itemsInCart,itemType: item2.category, name: item2.name,image:item2.image, price: item2.price, text: item2.description).navigationBarHidden(true)){
...
//                                        }
    ...
    init(itemsInCart:Binding<[FoodItem:Int]>,name:String="McDonald's",logo:String="mcdonald's_logo",stars:Float=4.8,distance:Float=5,noOfCoupons:Int = 0,items:Array<FoodItem>=mcDonaldsItemsArray){
