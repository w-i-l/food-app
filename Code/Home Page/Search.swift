                ...
                ScrollView(showsIndicators:false) {
                    ForEach(Array(stride(from: 0, to: searchArray.count, by: 2)),id:\.self){no in
                        ...
                        HStack(spacing:30){
                            ...
                            NavigationLink(destination:Item(itemsInCart:$itemsInCart,itemType: first.category, name: first.name, image: first.image, price: first.price, text: first.description).navigationBarTitle("").navigationBarHidden(true)) {
                            ...
                            if no+1<searchArray.count{
                                ...
                                NavigationLink(destination:Item(itemsInCart:$itemsInCart,itemType: second.category, name: second.name, image: second.image, price: second.price, text: second.description).navigationBarHidden(true).navigationBarTitle("")) {
