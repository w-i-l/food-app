...
//    init(items:[String:Array<String>] = ["BigMac": [],"Garniture": ["Fries","Dipping Fries"],"Drinks": ["Coca-Cola","Fanta","Sprite","Prigat","Water"]]){
    ...
    init(keys:Array<String>=["BigMac","Garniture","Drinks",],values:Array<Array<String>> = [[],["Fries","Dipping Fries"],["Coca-Cola","Fanta","Sprite","Prigat","Water"]],quantity:Int = 1,name:String="BigMac"){
